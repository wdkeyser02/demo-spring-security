...
public class CustomPasswordAuthenticationToken extends OAuth2AuthorizationGrantAuthenticationToken {
	...
	public CustomPasswordAuthenticationToken(final Authentication clientPrincipal, @Nullable final Set<String> scopes,
			@Nullable final Map<String, Object> additionalParameters) {
